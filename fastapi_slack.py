# With minor changes from https://github.com/dialoguemd-archives/fastapi-slack
...
async def on_startup():
    try:
        ...
        raise Exception("Missing environment variable(s) set SLACK_ACCESS_TOKEN and SLACK_SIGNING_SECRET") from error
